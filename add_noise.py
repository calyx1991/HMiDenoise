...
def add_noise(image, sigma=50):
    ...
    return gauss_noise.astype(np.float32) * 255
...
if __name__ == "__main__":
    ...
    for image_name in glob.glob(r'/scratch010/huangzhijuan/Datasets/ntire/2025/DN50/LSDIR_valid_HR/HR/val/*'):
        ...
        save_image(img_noise, image_name.replace('LSDIR_valid_HR/HR/val', 'LSDIR_valid_noise'))
